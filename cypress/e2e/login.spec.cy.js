...
describe('Registro de novo usuário com sucesso', () => {
  it('Deve registrar um novo usuário com informações válidas', () => {
    //Implemente os passos do caso de teste aqui: https://docs.google.com/spreadsheets/d/1IheRnj3Uwb4d6L1CGw6QHUXie_UxwcXbczcu32eiHcE/edit?usp=drive_link
...
describe('Enviar dinheiro com saldo suficiente', () => {
  it('Deve enviar dinheiro com sucesso', () => {
    ...
    cy.get('[data-test="user-list-item-WHjJ4qR2R2"] > .MuiListItemText-root > .MuiTypography-body1').click()              //Clica em "Description" e escreve um texto
